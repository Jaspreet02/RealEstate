...
namespace RealEstate
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register(User value, string roleName)
        {
            ...
            value.NormalizedUserName = value.UserName;
            ...
            if (result.Succeeded)
            {
               ...
               //"Please confirm your account by clicking this link: <a href=\""
                ...
                var emailDetail = new IdentityMessage()
                {
                    ...
                    Body = "Please confirm your account by clicki this link : <a href=\"" + callbackUrl + "\">link</a>"
                };
                _sendEmailService.SendEmail(emailDetail);
                return Ok(result);
            }
            else
            {
        ...
        public async Task<IActionResult> ConfirmEmail(string userId = "", string code = "")
        {
            ...
            if (user != null)
            {
                ...
                if (result.Succeeded) {
                    string url = Request?.GetDisplayUrl().Replace("8004","8003/Account/Login");
                    return Redirect(url);
                }
